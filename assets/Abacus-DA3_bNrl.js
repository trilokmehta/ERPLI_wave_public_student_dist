...
`;function p(){let e=(0,o.useRef)(null),n=(0,o.useRef)(null),r=(0,o.useRef)(null),c=(0,o.useRef)(null),p=(0,o.useRef)(null),m=(0,o.useRef)({scale:null,rotated:!1,x:0,y:0}),h=(0,o.useRef)(!1),g=(0,o.useRef)(null),[,_]=(0,o.useState)(0),[v,y]=(0,o.useState)(d),b=(0,o.useMemo)(()=>({rods:l(v.rods,1,25),lowerBeads:l(v.lowerBeads,1,9),centerRod:l(v.centerRod,1,l(v.rods,1,25))}),[v]),x=()=>_(e=>e+1),S=(0,o.useCallback)(()=>window.__abacus?.readState()??null,[]),C=(0,o.useCallback)(e=>window.__abacus?.applyState(e),[]),w=(0,o.useCallback)(e=>{h.current=e},[]),T=(e,t)=>{y(n=>{let r={...n,[e]:Number(t)},i=l(r.rods,1,25);return{rods:i,lowerBeads:l(r.lowerBeads,1,9),centerRod:l(r.centerRod,1,i)}})};return(0,o.useEffect)(()=>{m.current.scale=parseFloat(localStorage.getItem(`abacusScale`))||null,m.current.rotated=localStorage.getItem(`abacusRotated`)===`true`,m.current.x=parseFloat(localStorage.getItem(`abacusX`))||0,m.current.y=parseFloat(localStorage.getItem(`abacusY`))||0,localStorage.setItem(`abacusRods`,b.rods),localStorage.setItem(`abacusLowerBeads`,b.lowerBeads),localStorage.setItem(`abacusCenterRod`,b.centerRod);let t=e.current;if(!t)return;t.querySelectorAll(`.rod`).forEach(e=>e.remove());for(let e=0;e<b.rods;e++){let n=document.createElement(`div`);if(n.className=`rod`,(e-(b.centerRod-1))%3==0){let t=document.createElement(`div`);t.className=`rod-mark`,e+1===b.centerRod&&t.classList.add(`rod-mark-center`),n.appendChild(t)}let r=document.createElement(`div`);r.className=`bead heaven`,r.onclick=()=>{h.current||(r.classList.toggle(`active`),s())},n.appendChild(r);for(let e=0;e<b.lowerBeads;e++){let t=document.createElement(`div`);t.className=`bead earth`,t.onclick=()=>i(n,e),n.appendChild(t)}t.appendChild(n)}function i(e,t){if(h.current)return;let n=e.querySelectorAll(`.bead.earth`),r=n[t].classList.contains(`active`);n.forEach((e,n)=>{r?n>=t&&e.classList.remove(`active`):n<=t&&e.classList.add(`active`)}),s()}function a(){return Array.from(t.querySelectorAll(`.rod`)).map(e=>{let t=e.querySelector(`.heaven`).classList.contains(`active`)?b.lowerBeads+1:0;return t+=e.querySelectorAll(`.earth.active`).length,t})}function o(e){t.querySelectorAll(`.rod`).forEach((t,n)=>{let r=Number(e?.[n])||0,i=r>=b.lowerBeads+1,a=i?r-(b.lowerBeads+1):r;t.querySelector(`.heaven`).classList.toggle(`active`,i),t.querySelectorAll(`.earth`).forEach((e,t)=>{e.classList.toggle(`active`,t<a)})}),s(!0)}function s(e){let r=t.querySelectorAll(`.rod`),i=Array.from(r).map(e=>{let t=e.querySelector(`.heaven`).classList.contains(`active`)?b.lowerBeads+1:0;return t+=e.querySelectorAll(`.earth.active`).length,t}),a=-1;for(let e=i.length-1;e>=0;e--)if(i[e]>0){a=e;break}let o=-1;for(let e=0;e<i.length;e++)if(i[e]>0){o=e;break}let s=b.centerRod-1,c=`0`;if(a!==-1){let e=Math.min(o,s),t=i.slice(e,s+1).join(``).replace(/^0+(?=\d)/,``),n=i.slice(s+1,a+1).join(``).replace(/0+$/,``);c=t||`0`,n&&(c+=`.${n}`)}n.current&&(n.current.innerText=c),e||window.dispatchEvent(new CustomEvent(u))}function l(){let t=e.current,n=p.current;if(!t||!n)return;let r=m.current.rotated?t.offsetHeight:t.offsetWidth,i=n.clientWidth-40;m.current.scale=i/r,m.current.scale>1.5&&(m.current.scale=1.5),m.current.x=0,m.current.y=0,f(),setTimeout(d,100)}function d(){let e=p.current;e&&(e.scrollLeft=(e.scrollWidth-e.clientWidth)/2)}function f(){let e=c.current,t=r.current;if(!e)return;Number.isFinite(m.current.scale)||(m.current.scale=1);let n=m.current.rotated?`rotate(90deg)`:`rotate(0deg)`;if(e.style.transform=`translate(-50%, -50%) translate(${m.current.x}px, ${m.current.y}px) ${n} scale(${m.current.scale})`,t){let n=e.offsetWidth,r=e.offsetHeight,i=(m.current.rotated?r:n)*m.current.scale,a=(m.current.rotated?n:r)*m.current.scale;t.style.width=`${i}px`,t.style.height=`${a}px`}localStorage.setItem(`abacusScale`,m.current.scale),localStorage.setItem(`abacusRotated`,m.current.rotated),localStorage.setItem(`abacusX`,m.current.x),localStorage.setItem(`abacusY`,m.current.y);let i=p.current;(i&&m.current.rotated||i)&&(i.style.minHeight=`auto`)}m.current.scale===null?l():f(),setTimeout(d,150),g.current&&=(o(g.current),null),window.__abacus={readState(){return{v:a(),r:b.rods,lb:b.lowerBeads,c:b.centerRod}},applyState(e){if(e){if(Number(e.r)===b.rods&&Number(e.lb)===b.lowerBeads&&Number(e.c)===b.centerRod){o(e.v);return}g.current=e.v,y({rods:Number(e.r),lowerBeads:Number(e.lb),centerRod:Number(e.c)})}},rotateAbacus(){m.current.rotated=!m.current.rotated,f(),x()},changeScale(e){m.current.scale=Math.min(Math.max(.2,m.current.scale+e),3),f(),x()},moveAbacus(e,t){m.current.x+=e,m.current.y+=t,f(),x()},fitToScreen:()=>{l(),x()},resetBeads(){t.querySelectorAll(`.bead`).forEach(e=>e.classList.remove(`active`)),s(),x()}}},[b]),(0,s.jsxs)(`div`,{className:`sabacus-page`,children:[(0,s.jsx)(`style`,{children:f}),(0,s.jsx)(t,{}),(0,s.jsx)(a,{tool:i,changeEvent:u,serialize:S,apply:C,onReadOnlyChange:w}),(0,s.jsxs)(`div`,{className:`score-board`,children:[(0,s.jsxs)(`div`,{className:`score-center`,children:[(0,s.jsx)(`div`,{className:`score-label`,children:`Total Value`}),(0,s.jsx)(`div`,{className:`score-value`,ref:n,children:`0`})]}),(0,s.jsxs)(`div`,{className:`structure-controls`,children:[(0,s.jsxs)(`div`,{className:`field`,children:[(0,s.jsx)(`label`,{htmlFor:`abacus-rods`,children:`Rods`}),(0,s.jsx)(`input`,{id:`abacus-rods`,type:`number`,min:`1`,max:`25`,value:b.rods,onChange:e=>T(`rods`,e.target.value)})]}),(0,s.jsxs)(`div`,{className:`field`,children:[(0,s.jsx)(`label`,{htmlFor:`abacus-beads`,children:`Lower beads`}),(0,s.jsx)(`input`,{id:`abacus-beads`,type:`number`,min:`1`,max:`9`,value:b.lowerBeads,onChange:e=>T(`lowerBeads`,e.target.value)})]}),(0,s.jsxs)(`div`,{className:`field`,children:[(0,s.jsx)(`label`,{htmlFor:`abacus-center`,children:`Center rod`}),(0,s.jsx)(`input`,{id:`abacus-center`,type:`number`,min:`1`,max:b.rods,value:b.centerRod,onChange:e=>T(`centerRod`,e.target.value)})]})]}),(0,s.jsxs)(`div`,{className:`controls`,children:[(0,s.jsxs)(`div`,{className:`control-group`,children:[(0,s.jsx)(`button`,{className:`btn btn-icon`,title:`Rotate 90 degrees`,"aria-label":`Rotate 90 degrees`,onClick:()=>window.__abacus?.rotateAbacus(),children:`↻`}),(0,s.jsx)(`button`,{className:`btn btn-icon`,title:`Increase size`,"aria-label":`Increase size`,onClick:()=>window.__abacus?.changeScale(.1),children:`+`}),(0,s.jsx)(`button`,{className:`btn btn-icon`,title:`Decrease size`,"aria-label":`Decrease size`,onClick:()=>window.__abacus?.changeScale(-.1),children:`-`})]}),(0,s.jsxs)(`div`,{className:`control-group`,children:[(0,s.jsx)(`button`,{className:`btn btn-icon`,title:`Move up`,"aria-label":`Move up`,onClick:()=>window.__abacus?.moveAbacus(0,-30),children:`↑`}),(0,s.jsx)(`button`,{className:`btn btn-icon`,title:`Move down`,"aria-label":`Move down`,onClick:()=>window.__abacus?.moveAbacus(0,30),children:`↓`}),(0,s.jsx)(`button`,{className:`btn btn-clear btn-wide`,title:`Fit screen`,onClick:()=>window.__abacus?.fitToScreen(),children:`Fit`})]}),(0,s.jsx)(`button`,{className:`btn btn-wide`,style:{background:`#fee2e2`,color:`#e11d48`,borderColor:`#fecdd3`},title:`Reset beads`,onClick:()=>window.__abacus?.resetBeads(),children:`Reset`})]})]}),(0,s.jsx)(`div`,{className:`scroll-container`,ref:p,children:(0,s.jsx)(`div`,{className:`zoom-slot`,ref:r,children:(0,s.jsx)(`div`,{className:`zoom-layer`,ref:c,children:(0,s.jsx)(`div`,{className:`abacus-frame`,ref:e,children:(0,s.jsx)(`div`,{className:`beam`})})})})})]})}export{u as ABACUS_CHANGE_EVENT,p as default};